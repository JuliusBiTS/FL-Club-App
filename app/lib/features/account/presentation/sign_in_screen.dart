...
/// Briefing §9.3 step 2: "Register and sign-in are the same screen with a
/// segmented toggle." Reused standalone here (reachable from the You tab)
/// as well as inline during checkout once M3 adds that flow.
